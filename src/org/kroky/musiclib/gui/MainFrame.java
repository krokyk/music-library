...
import org.kroky.musiclib.config.Config;
...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnScanDir.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                btnScanDirActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(progressBar, GroupLayout.DEFAULT_SIZE, 929, Short.MAX_VALUE)
                .addContainerGap())
        );
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnScanDir))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(btnCheck)
                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(chkOnlySelected)
        ...
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.CENTER)
                    .addComponent(btnScanDir)
                    .addComponent(btnBrowse)
                    .addComponent(cbDirPath, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addGap(13, 13, 13)
    ...
    private void btnScanDirActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnScanDirActionPerformed
        ...
        if (!dir.isDirectory()) {
            JOptionPane.showMessageDialog(this, "No such directory exists, browse again.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        storeRecentDir(dir);
    ...
    private void btnDeleteActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        int retVal = JOptionPane.showConfirmDialog(this, "Are you sure you want to delete selected album(s)?", "Delete?", JOptionPane.YES_NO_OPTION);
    ...
    private void myInit() {
        Utils.centerOnParent(null, this);
        this.addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosing(java.awt.event.WindowEvent e) {
                try {
                    ...
                    LOG.warn("Unable to save user settings", ex);
                }
...
//        spBandsTable.setPreferredSize(new Dimension(500, 500));
        ...
        tableBands.getColumnModel().getColumn(2).setPreferredWidth(size - (tableBands.getColumnModel().getColumn(0).getPreferredWidth() + tableBands.getColumnModel().getColumn(1).getPreferredWidth()));
...
//        spAlbumsTable.setPreferredSize(new Dimension(500, 500));
        ...
        tableAlbums.getColumnModel().getColumn(2).setPreferredWidth(size - (tableAlbums.getColumnModel().getColumn(0).getPreferredWidth() + tableAlbums.getColumnModel().getColumn(1).getPreferredWidth()));
...
//        System.out.println(" + " + tableAlbums.getColumnModel().getColumn(2).getPreferredWidth());
        ...
        try {
            ...
            DbManager.getInstance().shutdownDb();
            JOptionPane.showMessageDialog(this, "DB Error occured. See the log for details. Application will close.", "Error", JOptionPane.ERROR_MESSAGE);
            System.exit(0);
        }

        final SortedUniqueListModel<RecentDir> cbModel = new SortedUniqueListModel<>(recentDirs, 10);
        cbModel.setSelectedItem(new RecentDir(CFG.getString("last.dir"), null));
